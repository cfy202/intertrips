		...
		<div class="main-content">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<button class="btn btn-turquoise" onclick="window.location.href='${ctx!}/admin/siteparam/add.do'">新增参数</button>
				...
				<div class="panel-body">
					...
					<table id="example-3" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
						<#list siteparams as siteparam>
							<tr>
							    <th class="no-sorting">
									<input type="checkbox" class="cbr">
								</th>
								<td>${(siteparam.name)!}</td>
								<td>${(siteparam.text)!}</td>
								<td>
									<a href="${ctx!}/admin/siteparam/update.do?id=${(siteparam.id)!}" class="btn btn-secondary btn-sm btn-icon icon-left">
										修改
									</a>
									<a href="${ctx!}/admin/siteparam/delete.do?id=${(siteparam.id)!}" class="btn btn-danger btn-sm btn-icon icon-left" onClick="return confirm('确定要删除?');">
										删除
									</a>
								</td>
							</tr>	
