...
<head>
	...
	$(document).ready(function() {
		...
		$("#uploadify1").uploadify({
			...
			'script': "${ctx!}/upload.do?path=images/food",
	 ...
	 function updateRegion(costnumber,region){
		   ...
		   $.ajax({
			...
			data: "costnumber="+costnumber+"&type=7",
			cache:false,
			success: function(data) {
			   $.each(data, function(i, des) {
			    ...
			    $("#regionid").val("${(food.regionid)}").trigger("change");
			    }else{
...
<body class="page-body">
	...
	<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
		...
		<div class="main-content">
			...
			<form role="forl" action="${ctx!}/admin/food/save.do" id="rootwizard" method="post" class="form-wizard validate">
				...
				<div class="tab-content no-margin">
					...
					<div class="tab-pane with-bg" id="fwv-2">
							<div class="row">
									...
									<div class="form-group">
											<label class="col-sm-2 control-label">美食分类</label>
											
											<div class="col-sm-10">
												<select class="form-control" id = "regionid" value="${(food.regionid)!}" name = "regionid">
					...
					<div class="row">
								<div class="form-group">
									<label class="col-sm-2 control-label" for="foodname">英文名称</label>								
									<div class="col-sm-10">
										<input type="text" name="foodname" value="${(food.foodname)!}" class="form-control" id="foodname" placeholder="">
									</div>
								</div>
						...
						<div class="row">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="foodcn" value="${(food.foodcn)!}" class="form-control" id="field-2" placeholder="">
									</div>
								</div>
							</div>
						 <br />
						...
						<div class="row">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select class="form-control" name="foodstar" id="foodstar">
											<#list ["5","4.5","4","3.5","3","2"] as star>
          										<option value="${star}" <#if food.foodstar?? && "${(food.foodstar)!}"=="${star}">selected="selected"</#if>>${star}</option> 
          									</#list> 
										</select>
									</div>
								</div>
									...
									<div class="col-sm-10">
										<select class="form-control" name="destinationid" id="UPID" >
											<#list destination as destination>
            									<option value="${(destination.id)!}" <#if food.destinationid ?? && food.destinationid=destination.id>selected="selected"</#if>>${(destination.name)!}-${(destination.namecn)!}</option>
            								</#list>
										</select>
									</div>
								</div>
						...
						<div class="row">
							    ...
							    <div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="telephone" value="${(food.telephone)!}" class="form-control" placeholder="">
									</div>
								</div>
						</div>
						...
						<div class="row">
							<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" name="address"  cols="5" id="field-5">${(food.address)!}</textarea>
									</div>
								</div>
						</div>
						...
						<div class="row">
							<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" name="fooddescription"  cols="5" id="field-5">${(food.fooddescription)!}</textarea>
									</div>
								</div>
						</div>
						...
						<div class="row">
							<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" name="foodlocation"  cols="5" id="field-5">${(food.foodlocation)!}</textarea>
									</div>
								</div>
						</div>
						...
						<div class="row">
							<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" name="foodamenities"  cols="5" id="field-5">${(food.foodamenities)!}</textarea>
									</div>
								</div>
						</div>
						...
						<div class="row">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="sort"  value="${(food.sort)!}" class="form-control" id="field-2" placeholder="">
									</div>
								</div> 
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
								    ...
								    <input name="productid" type="hidden" id="id" value="${(food.productid)!}">
