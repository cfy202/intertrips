				...
				<div class="tab-content no-margin">
					...
					<div class="row">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="foodname" class="form-control" id="foodname" placeholder="">
									</div>
								</div>
						...
						<div class="row">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="foodcn" class="form-control" id="field-2" placeholder="">
									</div>
								</div>
							</div>
						 <br />
						...
						<div class="row">
							<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" name="address"  cols="5" id="field-5"></textarea>
									</div>
								</div>
						</div>
						...
						<div class="row">
							<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" name="fooddescription"  cols="5" id="field-5"></textarea>
									</div>
								</div>
						</div>
						...
						<div class="row">
							<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" name="foodlocation"  cols="5" id="field-5"></textarea>
									</div>
								</div>
						</div>
						...
						<div class="row">
							<div class="form-group">
									<label class="col-sm-2 control-label" for="field-5">环境描述</label>
									<div class="col-sm-10">
										<textarea class="form-control" name="foodamenities"  cols="5" id="field-5"></textarea>
									</div>
								</div>
						</div>
