						...
						<div class="panel-body">
							...
							<form role="form" class="form-horizontal" action="${ctx!}/admin/role/save.do" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="name" value="${role.name}" class="form-control" id="field-1" placeholder="">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="title" value="${role.title}" class="form-control" id="field-1" placeholder="">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="editname" value="${role.editname}" class="form-control" id="field-1" placeholder="">
									</div>
								</div>
										...
										<#if treelist.level??&&treelist.level =1>
										 <div style="margin-left: 35px;">
										  ...
										  <div>
										    ...
										    <#list roletree as roletree >
													<#if treelist.id==roletree.treeid >
													checked="checked"
													</#if>
													</#list>
										    >
											...
											<#if treelist.level??&&treelist.level !=0 >
											     <#list treelist.opationIds?split(",") as urls> 
											       <div style="margin-left: 50px;"  > 
											         <input tabindex="5" type="checkbox" class="icheck-14" name = "${treelist.id}" value="${urls}" id="minimal-checkbox-1-11" 
											         <#list roletree as roletree >
											          <#if (roletree.opationIds?? && roletree.opationIds?index_of("${urls}")!=-1)>checked="checked"</#if>
													</#list>
											          >
									...
									<#list costlist as costlist  >
										...
										<div class="checkbox">
											<label>
												...
												<#list rolecost as rolecost >
													<#if costlist.id==rolecost.costnumber >
													checked="checked"
													</#if>
													</#list>
												>
