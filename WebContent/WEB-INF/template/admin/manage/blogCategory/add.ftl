				...
				<div class="col-sm-12">
					<div class="panel panel-default">
						<div class="panel-body">
							<form role="form"  class="form-horizontal" action="${ctx!}/admin/blogCategory/save.do" method="post">

								<div class="form-group-separator"></div>
								<div class="form-group">
									<label class="col-sm-2 control-label" for="field-1">名称：</label>
									<div class="col-sm-10">
									   <input type="text" class="form-control" id="field-3" name="name">
									</div>
								</div>
									...
									<div class="col-sm-10">
										<p>
											<label class="checkbox-inline">
												<input type="checkbox" name="isShow" value="1" checked="checked">展示
											</label>											
										</p>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="page.templateUrl" value="/front/blog/blogList.ftl" class="form-control" placeholder="">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="page.filepath" class="form-control" id="generalPathInput" placeholder="">
									</div>
								</div>									
