				...
				<div class="tab-content no-margin">
					...
					<div class="row">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="visatype"  class="form-control" id="visaname" placeholder="">
									</div>
								</div> 
						...
						<div class="row">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
									<input type="text" name="handlelength"   class="form-control" id="field-2"  placeholder="">
									</div>
								</div>
							</div>
						 <br />
						...
						<div class="row">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
									<input type="text" name="visavalid"   class="form-control" id="field-2"  placeholder="">
									</div>
								</div>
							</div>
						 <br />
						<div class="form-group-separator"></div><div class="row">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
									<input type="text" name="numberentries"   class="form-control" id="field-2"  placeholder="">
									</div>
								</div>
							</div>
						 <br />
						...
						<div class="row">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
									<input type="text" name="stayingdays"   class="form-control" id="field-2"  placeholder="">
									</div>
								</div>
							</div>
						 <br />
						...
						<div class="row">
							...
							<div class="form-group">
									...
									<div class="col-sm-10">
	                                    <textarea class="form-control" name="acceptancerange" id="metadescription" 
	                                    rows="6" placeholder="受理范围" >
	                                    </textarea>
									</div>
								</div>
						</div>
