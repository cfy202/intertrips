						...
						<div class="panel-body">
							...
							<form role="form" class="form-horizontal" action="${ctx!}/admin/manager/save.do" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="username" class="form-control" id="field-1" placeholder="">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="password" name="password" class="form-control" id="field-2" placeholder="Placeholder (Password)">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="email" class="form-control" id="field-1" placeholder="">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="remark" class="form-control" id="field-1" placeholder="">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
									    <img src="${ctx!}${(admin.imageurl)!}" id="imgshow">
									</div>
									<div class="col-sm-10">
										<input type="file" class="form-control" id="uploadify" name="uploadify">
										<input type="hidden" name="imageurl" id="changephoto" value="${(admin.imageurl)!}"/>
									</div>
								</div>
