		...
		<div class="main-content">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<button class="btn btn-turquoise" onclick="window.location.href='${ctx!}/admin/currency/add.do'">添加币种</button>
					...
					<table id="example-3" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<#list currencies as currency>
							<tr>
								...
								<td>${(currency.sort)!}</td>
								<td>
									<a href="${ctx!}/admin/currency/update.do?id=${(currency.id)!}" class="btn btn-secondary btn-sm btn-icon icon-left">
										修改
									</a>
									<a href="${ctx!}/admin/currency/delete.do?id=${(currency.id)!}" class="btn btn-danger btn-sm btn-icon icon-left" onClick="return confirm('确定要删除?');">
										删除
									</a>
								</td>
							</tr>	
