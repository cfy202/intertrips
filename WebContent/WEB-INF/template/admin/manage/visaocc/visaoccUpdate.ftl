					...
					<div class="breadcrumb-env">
						<ol class="breadcrumb bc-1">
						  ...
						  <li>
							...
							<li class="active">
								<a href=""><strong>签证管理—职业修改</strong></a>
							</li>
						</ol>
				</div>
			</div>
						...
						<div class="panel-body">
							<form role="form" class="form-horizontal" action="${ctx!}/admin/visaocc/save.do" method="post" id="loginForm">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="title" value="${(visaoccupation.title)!}" name="title">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select class="form-control" name="typeName" id="destinationid">
											<option value="在职人员" <#if visaoccupation.typeName??&&visaoccupation.typeName='在职人员' ></#if>>在职人员</option>
											<option value="自由职业" <#if visaoccupation.typeName??&&visaoccupation.typeName='自由职业' ></#if>>自由职业</option>
											<option value="在校学生" <#if visaoccupation.typeName??&&visaoccupation.typeName='在校学生' ></#if>>在校学生</option>
											<option value="退休" <#if visaoccupation.typeName??&&visaoccupation.typeName='退休' ></#if>>退休</option>
											<option value="学龄前儿童" <#if visaoccupation.typeName??&&visaoccupation.typeName='学龄前儿童' ></#if>>学龄前儿童</option>
										</select>
									</div>
								</div>
								<div class="form-group-separator"></div>
								<div class="form-group">
									...
									<div class="col-sm-10">
									    <textarea class="form-control" name="content" cols="5" rows="6" id="passport">${(visaoccupation.content)!}</textarea>
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-sm-10" align="center">
									    ...
									    <input type="hidden" name = "visaId" value="${(visaoccupation.visaId)!}" >
