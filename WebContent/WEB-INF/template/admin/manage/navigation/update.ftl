	...
	$(document).ready(function() {
		  ...
		  $('#type').bind('change', function () {
		       ...
		       $.ajax({
	             ...
	             data: {costnumber:costnumber, type:type, id:id},
	             dataType: "json",
					...
					<div class="breadcrumb-env">
						<ol class="breadcrumb bc-1">
						  ...
						  <li>
							...
							<li class="active">
								<a href="${ctx!}/admin/navigation/add.do"><strong>导航修改</strong></a>
							</li>
						</ol>
				</div>
			</div>
				...
				<div class="col-sm-12">
					<div class="panel panel-default">
						<div class="panel-body">
							<form role="form" class="form-horizontal" id="rootwizard" action="${ctx!}/admin/navigation/save.do?id=${(navigation.id)!}" method="post">
								<div class="form-group">
									<label class="col-sm-2 control-label" for="field-1">名称：</label>
									<div class="col-sm-10">
									   <input type="text" class="form-control" id="field-1" name="name" value="${(navigation.name)!}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="field-2" name="url" value="${(navigation.url)!}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<input type="hidden" name="costnumber" id="costnumber" value="${(navigation.costnumber)!}">
									</div>
								</div>
								-->
								<input type="hidden" name="costnumber" id="costnumber" value="${(navigation.costnumber)!}">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
									   <select name="type" class="form-control" id="type">
									       <option value="1" <#if navigation.type==1>selected="selected"</#if>>上导航</option>
									       <option value="2" <#if navigation.type==2>selected="selected"</#if>>下导航</option>
									    </select>
									</div>
								</div>
								<div class="form-group-separator"></div>
										...
										<select class="form-control" name="upid" id="upid">
										  <option value="root">根目录</option>
											<#list navigation2 as navigation2>
            									<option value="${(navigation2.id)!}" <#if navigation.upid?? && navigation.upid = navigation2.id>selected="selected"</#if>>
            									   ${(navigation2.levelstr)!}${(navigation2.name)!}
            									</option>
            								</#list>
										</select>
									</div>
									...
									<div class="col-sm-10">
										<p>
											<label class="checkbox-inline">
												<input type="checkbox" name="isShow" value="1"<#if navigation.isShow?? && navigation.isShow=1>checked="checked"</#if>>显示
											</label>											
										</p>
									</div>
								</div>
