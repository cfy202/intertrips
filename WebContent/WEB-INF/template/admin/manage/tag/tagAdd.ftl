				...
				<div class="title-env">
					...
					<div class="breadcrumb-env">
						<ol class="breadcrumb bc-1">
						  ...
						  <li>
							<a href="${ctx!}/admin/tag/list.do">标签管理</a>
						  </li>
							<li class="active">
								<a href="${ctx!}/admin/tag/add.do"><strong>产品标签添加</strong></a>
							</li>
						</ol>
				</div>
			</div>
				...
				<div class="col-sm-12">
					<div class="panel panel-default">
						<div class="panel-body">
							<form role="form" class="form-horizontal" action="${ctx!}/admin/tag/save.do" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<div class="input-group">
										    <input type="text" value="ffffff" name="textcolor" class="pick-a-color form-control">
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<div class="input-group">
											 <input type="text" value="ffae2f" name="bgcolor"" class="pick-a-color form-control">
										</div>
									</div>
								</div>
								-->
