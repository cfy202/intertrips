              ...
              $.each(data.allImages, function(i, e) {
                 ...
                 html +=   "<div class=\"col-md-3 col-sm-4 col-xs-6\">"+
								"<div class=\"album-image\">"+
								     ...
								     "</div>"+
									 "<div class=\"\">"+
									     "<input type=\"radio\" id=\"icoUrl"+i+"\" name=\"icoUrl\" value=\""+e.url+"\"/>"+
									 "</div>"+
								 "</div>"+
							  "</div>";
			});
				...
				<div class="col-sm-12">
					<div class="panel panel-default">
						<div class="panel-body">
							<form role="form" class="form-horizontal" action="${ctx!}/admin/serviceitem/update.do" method="post">
								<input name="id" value="${serviceItem.id}" type="hidden"/>
								<div class="form-group-separator"></div>
								<div class="form-group">
									<label class="col-sm-2 control-label" for="field-1">标题：</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" id="field-1" name="tittle" value="${(serviceItem.tittle)!}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
									    <label>  
									       <input type="radio" value="fa-circle-o" name="ico" <#if serviceItem.ico??&&serviceItem.ico='fa-circle-o'>checked</#if> >&nbsp;&nbsp;&nbsp;
									       <i class="fa-circle-o"></i></span>
									    </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
									    <label>  
									       <input type="radio" value="fa-plane" name="ico" <#if serviceItem.ico??&&serviceItem.ico='fa-plane'>checked</#if> >&nbsp;&nbsp;&nbsp;
									       <i class="fa-plane "></i></span>
									    </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									    <label>  
									       <input type="radio" value="linecons-food" name="ico" <#if serviceItem.ico??&&serviceItem.ico='linecons-food'>checked</#if>>&nbsp;&nbsp;&nbsp;
									       <i class="linecons-food"></i></span>
									    </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									    <label>  
									       <input type="radio" value="fa-anchor" name="ico" <#if serviceItem.ico??&&serviceItem.ico='fa-anchor'>checked</#if>>&nbsp;&nbsp;&nbsp;
									       <i class="fa-anchor"></i></span>
									    </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									    <label>  
									       <input type="radio" value="fa-building" name="ico" <#if serviceItem.ico??&&serviceItem.ico='fa-building'>checked</#if>>&nbsp;&nbsp;&nbsp;
									       <i class="fa-building"></i></span>
									    </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									    <label>  
									       <input type="radio" value="fa-car" name="ico" <#if serviceItem.ico??&&serviceItem.ico='fa-car'>checked</#if>>&nbsp;&nbsp;&nbsp;
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										  <div id="uppic">
										    <img src="${ctx!}${(serviceItem.icoUrl)!}" id="imgshow" style="width:800px!important;height:500px!important"/><br/>
										  ...
										  <div id="upurl">
										     <input type="hidden" name="icoUrl" id="changephoto" value="${(serviceItem.icoUrl)!}"/>
										  </div>
									</div>
