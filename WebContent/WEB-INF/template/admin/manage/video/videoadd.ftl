...
<head>
	...
	$(document).ready(function() {
		...
		$("#uploadify").uploadify({
				        ...
				        'script' : '${ctx!}/upload.do?path=images/video',
					...
					<div class="breadcrumb-env">
						<ol class="breadcrumb bc-1">
						  ...
						  <li>
							...
							<li class="active">
								<a href="${ctx!}/admin/video/add.do"><strong>视频添加</strong></a>
							</li>
						</ol>
				</div>
			</div>
				...
				<div class="col-sm-12">
					<div class="panel panel-default">
						<div class="panel-body">
							<form role="form" class="form-horizontal" action="${ctx!}/admin/video/save.do" method="post">
							    <#if (cost?size==1)>
								...
								<div class="form-group">
									<label class="col-sm-2 control-label" for="uploadify">视频：</label>
									<div class="col-sm-10">
										  <div id="uppic">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
									   <input type="text" class="form-control" id="field-3" name="title">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
									    <textarea class="form-control" name="infor" cols="5" id="field-1"></textarea>
									</div>
								</div>
								<div class="form-group-separator"></div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select name="type" class="form-control" id="type">
									          <option value="1">共享视频</option>
									          <option value="2">私有视频</option>
									          <#--
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="field-3" name="url">
									</div>
								</div>
