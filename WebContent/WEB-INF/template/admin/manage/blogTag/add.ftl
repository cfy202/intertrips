				...
				<div class="breadcrumb-env">
						<ol class="breadcrumb bc-1">
						  ...
						  <li>
							...
							<li class="active">
								<a href="${ctx!}/admin/blogTag/add.do"><strong>博客标签添加</strong></a>
							</li>
						</ol>
				</div>
			</div>
				...
				<div class="col-sm-12">
					<div class="panel panel-default">
						<div class="panel-body">
							<form role="form" class="form-horizontal" action="${ctx!}/admin/blogTag/save.do" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="page.filepath" class="form-control" id="field-2" placeholder="">
									</div>
								</div>										
								<div class="form-group-separator"></div>
								<div class="form-group">
