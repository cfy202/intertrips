              ...
              $.each(data.allImages, function(i, e) {
                 ...
                 html +=   "<div class=\"col-md-3 col-sm-4 col-xs-6\">"+
								"<div class=\"album-image\">"+
								     ...
								     "</div>"+
									 "<div class=\"\">"+
									     "<input type=\"radio\" id=\"url"+i+"\" name=\"url\" value=\""+e.url+"\"/>"+
									 "</div>"+
								 "</div>"+
							  "</div>";
			});
					...
					<div class="breadcrumb-env">
						<ol class="breadcrumb bc-1">
						  ...
						  <li>
							...
							<li class="active">
								<a href="${ctx!}/admin/slider/add.do"><strong>幻灯片图片修改</strong></a>
							</li>
						</ol>
				</div>
			</div>
				...
				<div class="col-sm-12">
					<div class="panel panel-default">
						<div class="panel-body">
							<form role="form" class="form-horizontal" action="${ctx!}/admin/slider/save.do?id=${(slider.id)!}" method="post">
							    <#if (cost?size==1)>
								<input type="hidden" name="costnumber" id="costnumber" value="${(slider.costnumber)!}">
								<#else>
								<div class="form-group">
									...
									<div class="col-sm-10">
									    <select name="costnumber" class="form-control" id="costnumber">
									       <#list cost as cost>
									          <option value="${(cost.id)!}" <#if (cost.id)=(slider.costnumber)>selected="selected"</#if>>${cost.name}</option>
									       </#list>
									    </select>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										  <div id="uppic">
										    <img src="${ctx!}${(slider.url)!}" id="imgshow" style="width:800px!important;height:500px!important"/><br/>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
								    	<textarea class="form-control" name="description" cols="5" id="field-1">${(slider.description)!}</textarea>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
									   <select name="type" class="form-control" id="type">
									          <option value="1" <#if slider.type?? && slider.type==1>selected="selected"</#if>>首页幻灯片</option>
									          <option value="2" <#if slider.type?? && slider.type==2>selected="selected"</#if>>签证页幻灯片</option>
									          <#--
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<div class="checkbox">
											<label>
												<input type="checkbox" name="isshow" value="1" <#if slider.isshow=1>checked="checked"</#if>>显示
											</label>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="field-3" name="link" value="${(slider.link)!}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="sort" name="sort" value="${(slider.sort?c)!}">
									</div>
								</div>
