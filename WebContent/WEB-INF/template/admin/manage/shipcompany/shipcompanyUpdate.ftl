...
<script type="text/javascript">
              ...
              $.each(data.allImages, function(i, e) {
                 ...
                 html +=   "<div class=\"col-md-3 col-sm-4 col-xs-6\">"+
								"<div class=\"album-image\">"+
									 "<label for=\"url"+i+"\">"+
										 "<img src=\"${ctx!}"+e.logourl+"\" class=\"img-responsive\" />"+
								     ...
								     "</div>"+
									 "<div class=\"\">"+
									     "<input type=\"radio\" id=\"url"+i+"\" name=\"logourl\" value=\""+e.url+"\"/>"+
									 "</div>"+
								 "</div>"+
							  "</div>";
			});
	...
	function upload(){
	   ...
	   $('#page').empty();
	   $('#uppic').show();
	   var html = "<input type=\"hidden\" name=\"logourl\" id=\"changephoto\" value=\"\"/>";
				...
				<div class="title-env">
					...
					<div class="breadcrumb-env">
						<ol class="breadcrumb bc-1">
						  ...
						  <li>
							<a href="${ctx!}/admin/shipcompany/list.do">游船公司管理</a>
						  </li>
							<li class="active">
								<a href="#"><strong>游船公司修改</strong></a>
							</li>
						</ol>
				</div>
			</div>
				...
				<div class="col-sm-12">
					<div class="panel panel-default">
						<div class="panel-body">
							<form role="form" class="form-horizontal" action="${ctx!}/admin/shipcompany/save.do?id=${(shipcompany.id)!}" method="post">
								<div class="form-group">
									<label class="col-sm-2 control-label" for="field-1">名称：</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" id="field-1" name="name" value="${(shipcompany.name)!}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control ckeditor" rows="10" name="description" id="text">
	                                       ${(shipcompany.description)!}
					                    </textarea>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										  <div id="uppic">
										    <img src="${ctx!}${(shipcompany.logourl)!}" id="imgshow" style="width:800px!important;height:500px!important"/><br/>
										  ...
										  <div id="upurl">
										     <input type="hidden" name="url" id="changephoto" value="${(shipcompany.logourl)!}"/>
										  </div>
									</div>
								...
								<div class="form-group-separator"></div>
								 <div class="row">
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" name="orderid" value="${(shipcompany.orderid)!}" class="form-control" id="field-2" placeholder="">
											</div>
										</div> 
						          </div>
						        <div class="form-group-separator"></div>
								<div class="form-group">
									<div class="col-sm-10" align="center">
										...
										<input type="button" value="取消" class="btn btn-success" onClick="location.href='${ctx!}/admin/shipcompany/list.do';">
									</div>
								</div>
							</form>
						</div>
