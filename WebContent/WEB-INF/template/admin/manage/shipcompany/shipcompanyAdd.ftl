...
<head>
	...
	$(document).ready(function() {
		...
		$("#uploadify").uploadify({
				        ...
				        'script' : '${ctx!}/upload.do?path=images/ship',
              ...
              $.each(data.allImages, function(i, e) {
                 ...
                 html += "<div class=\"col-md-3 col-sm-4 col-xs-6\">"+
										"<div class=\"album-image\">"+
										    ...
										    "</div>"+
										    "<div class=\"\">"+
											   "<input type=\"radio\" id=\"url"+a+"\" name=\"logourl\" value=\""+e.url+"\"/>"+
										    "</div>"+
									    "</div>"+
								    "</div>";
			});
					...
					<div class="breadcrumb-env">
						<ol class="breadcrumb bc-1">
						  ...
						  <li>
							...
							<li class="active">
								<a href="${ctx!}/admin/shipcompany/add.do"><strong>游船公司添加</strong></a>
							</li>
						</ol>
				</div>
			</div>
				...
				<div class="col-sm-12">
					<div class="panel panel-default">
						<div class="panel-body">
							<form role="form" class="form-horizontal" action="${ctx!}/admin/shipcompany/save.do" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control ckeditor" rows="10" name="description">
					                    </textarea>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										  ...
										  <div id="upurl">
										     <input type="hidden" name="logourl" id="changephoto" value=""/>
										  </div>
									</div>
								...
								<div class="form-group">
									<div class="col-sm-10" align="center">
									    <input type = "hidden" name ="id" value="${(shipcompany.id)!}">
