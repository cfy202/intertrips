					...
					<div class="breadcrumb-env">
							...
							<a href="${ctx!}/admin/list.do"><i class="fa-home"></i>首页</a>
								...
								<li>
										...
										<a href="${ctx!}/admin/page/list.do">单页面管理</a>
								</li>
							<li class="active">
				...
				<div class="col-sm-12">
					...
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<form role="form" class="form-horizontal" action="${ctx!}/admin/page/save.do" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="tel" class="form-control" id="field-1" placeholder="">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="templateUrl" class="form-control" placeholder="">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="filepath" class="form-control" id="field-2" placeholder="">
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-sm-10" align="center">
										...
										<input type="button" name="name" class="btn btn-secondary btn-sm btn-icon icon-left" value="取消" onClick="location.href='${ctx!}/admin/page/list.do';">
									</div>
								</div>
							</form>
						</div>
