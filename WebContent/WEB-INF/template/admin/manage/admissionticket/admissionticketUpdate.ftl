...
<head>
	...
	$(document).ready(function() {
	    ...
	    var region = "${(admissionticket.regionid)}";
		   ...
		   $.ajax({
			...
			success: function(data) {
			   $.each(data, function(i, des) {
			    ...
			    $("#regionid").val("${(admissionticket.regionid)}").trigger("change");
			    }else{
				...
				<div class="tab-content no-margin">
					...
					<div class="row">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="admissionticketname" value="${(admissionticket.ticketname)!}" class="form-control" id="admissionticketname" placeholder="">
									</div>
								</div>
						...
						<div class="row">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="admissionticketcn" value="${(admissionticket.ticketcn)!}" class="form-control" id="field-2" placeholder="">
									</div>
								</div>
							</div>
						 <br />
									...
									<div class="col-sm-10">
										<select class="form-control" name="attractionid" id="UPID" >
											<#list attraction as attraction>
            									<option value="${(attraction.id)!}" <#if admissionticket.attractionid ?? && admissionticket.attractionid=attraction.id>selected="selected"</#if>>${(attraction.name)!}-${(attraction.namecn)!}</option>
            								</#list>
										</select>
									</div>
								</div>
						...
						<div class="row">
							<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" name="ticketinclude"  cols="5" id="field-5">${(admissionticket.ticketinclude)!}</textarea>
									</div>
								</div>
						</div>
						...
						<div class="row">
							<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" name="notinclude"  cols="5" id="field-5">${(admissionticket.notinclude)!}</textarea>
									</div>
								</div>
						</div>
						...
						<div class="row">
							<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" name="ticketdescription"  cols="5" id="field-5">${(admissionticket.ticketdescription)!}</textarea>
									</div>
								</div>
						</div>
						...
						<div class="row">
							<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" name="ticketamenities"  cols="5" id="field-5">${(admissionticket.ticketamenities)!}</textarea>
									</div>
								</div>
						</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
								    ...
								    <input name="productid" type="hidden" id="id" value="${(admissionticket.productid)!}">
