				...
				<div class="col-sm-12">
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<form role="form" class="form-horizontal" action="${ctx!}/admin/itinerary/addsave.do" method="post">
									...
									<div class="col-sm-10">
										<select class="form-control" name="day" id="day">
											<#list daylist as daylist>
            									<option value="${daylist}" <#if daymax?? && daymax=daylist>selected="selected"</#if>>${daylist}</option>
            								</#list>
										</select>	
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="title" value="" class="form-control" id="field-2" placeholder="">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" name="content" cols="5" rows="13" id="content"></textarea>
									</div>
								</div>
										...
										<select class="form-control" name="hotelId">
											...
											<#if hotels?has_content>
											   <#list hotels as hotels>
											        <option value="${(hotels.id)!}">${(hotels.hotelname)!}</option>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
									    <input type="text"  name="hotelRemark" value="" class="form-control" id="field-2" placeholder="酒店说明">
									</div>
								</div>
										  ...
										  $.ajax({
											   ...
											   $("#itintaryCids").empty();
										         $.each(msg, function (index, entry) {
										            ...
										            $("#itintaryCids").append("<option  value='"+entry['id']+"' selected>"+entry['name']+"--"+entry['namecn']+"</option>");
										            }else{
										            $("#itintaryCids").append("<option  value='"+entry['id']+"'>"+entry['name']+"--"+entry['namecn']+"</option>");
										            } 
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<#list ["飞机","火车","轮船","汽车"] as trafficlist>
												<input type="checkbox" name="traffic" value="${trafficlist}"/>
												${trafficlist}&nbsp;&nbsp;
										</#list>	
									</div>
								</div> 
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" name="meal" cols="5" rows="1" id="field-5"></textarea>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" name="reminder" cols="5" rows="3" id="field-5"></textarea>
									</div>
								</div>
						...
						-->
										<input name="tourlineid"  type="hidden" id="id" value="${tourlineId!}">
										<input name="id" type="hidden" id="id" value="${id!}">
										<input type="submit" name="button" id="button" value="保存并继续添加" class="btn btn-secondary btn-sm btn-icon icon-left">
										<input type="button" name="name" value="取消" onClick="location.href='${ctx!}/admin/itinerary/list.do?tourlineId=${tourlineId!}';" class="btn btn-secondary btn-sm btn-icon icon-left">
									</div>								
								</div>     		
							</form>
						</div>
