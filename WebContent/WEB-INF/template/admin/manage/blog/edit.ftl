...
<head>
	...
	$(document).ready(function() {
		...
		$("#blogForm").submit(function(){
			...
			var $isRecommended = $("#isRecommendedChecked");
			var content;
			var $stickyCheck = $("#stickyCheck");
			if(!$isRecommended.is(":checked")){
				$(this).append('<input type="hidden" name="isRecommended" value="0">');
			}
			if(!$stickyCheck.is(":checked")){
				$(this).append('<input type="hidden" name="sticky" value="0">');
			}
				...
				<div class="breadcrumb-env">
						<ol class="breadcrumb bc-1">
						  ...
						  <li>
							...
							<li class="active">
								<a href="${ctx!}/admin/blog/add.do"><strong>博客编辑</strong></a>
							</li>
						</ol>
				</div>
			</div>
				...
				<div class="col-sm-12">
					<div class="panel panel-default">
						<div class="panel-body">
							<form id="blogForm" role="form" class="form-horizontal" action="${ctx!}/admin/blog/update.do" method="post">
								<input type="hidden" name="id" value="${blog.id}">
								<input type="hidden" name="page.Id" value="${blog.pageId}"/>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
									   <input type="text" class="form-control" id="field-3" name="tittle" value="${blog.tittle}">
									</div>
								</div>
								...
								<div class="row">		
										<div class="form-group">
											...
											<div class="col-sm-10" id="IMAGEURL">
												<#if blog.coverImageUrl?has_content>
												<img src="${ctx!}${blog.coverImageUrl}" alt="" height="100" width="150" onclick="cancel(this)" class="${blog.coverImageId}">
												</#if>
											</div>
										</div>
										<div id="IMAGEID"></div>
							   ...
							   <div class="form-group">
										...
										<div class="col-sm-10">
											<p>
												<label class="checkbox-inline">
													<input id="stickyCheck" type="checkbox" name="sticky" value="1" <#if blog.sticky = 1>checked</#if>>显示
												</label>											
											</p>
										</div>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<p>
											<label class="checkbox-inline">
												<input id="isRecommendedChecked" type="checkbox" name="isRecommended" value="1" <#if blog.isRecommended = 1>checked</#if>>推荐
											</label>											
										</p>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<p>
											<label class="checkbox-inline">
												<input type="radio" name="commentStatus" value="1" <#if blog.commentStatus = 1>checked</#if>>
												允许评论
											</label>
											<label class="checkbox-inline">
												<input type="radio" name="commentStatus" value="0" <#if blog.commentStatus = 0>checked</#if>>
												禁止评论
											</label>
										</p>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<p>
											<label class="checkbox-inline">
												<input type="radio" name="pingStatus" value="1" <#if blog.pingStatus = 1>checked</#if>>
												允许共享
											</label>
											<label class="checkbox-inline">
												<input type="radio" name="pingStatus" value="0" <#if blog.pingStatus = 0>checked</#if>>
												禁止共享
											</label>
										</p>
									</div>
								...
								<div class="form-group" style="margin-left:125px">
									<label class="col-sm-1 control-label" for="field-5">内容：</label>
										<div class="col-sm-11">
										<script type="text/plain" id="content" style="width:100%">${(blog.content)!}</script>
										</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" id="beginDate" name="releaseTime" class="text Wdate" value="${blog.releaseTime?string('yyyy-MM-dd hh:mm:ss')}" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss'});" />
									</div>
								</div>
									...
									<div class="col-sm-10">
										<select name="categoryId" class="form-control" id="type">
										  <#list blogCategoryList as blogCategory>
								              <option value="${blogCategory.id}" <#if blogCategory.id = blog.categoryId>selected</#if>>${blogCategory.name}</option>
								          </#list>
									    </select>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="page.metatitle" value="${(blog.page.metatitle)!}" class="form-control" id="field-1" placeholder="">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" name="page.metakeywords" cols="5" id="field-5">${(blog.page.metakeywords)!}</textarea>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" name="page.metadescription" cols="5" id="field-5">${(blog.page.metadescription)!}</textarea>
									</div>
								</div>	
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="page.templateUrl" class="form-control" value="${(blog.page.templateUrl)!}" placeholder="">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="page.filepath" value="${(blog.page.filepath)!}" class="form-control" id="field-2" placeholder="">
									</div>
								</div>									
