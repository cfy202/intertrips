						...
						<div class="panel-body">
							...
							<form role="form" class="form-horizontal" action="${ctx!}/admin/cost/save.do" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea name="remark" class="form-control" cols="5" id="field-5"></textarea>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="sign" class="form-control" id="field-1" placeholder="如：￥或$">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<input type="text" name="code" class="form-control" id="field-1" placeholder="如：CNY或USD">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
									  <div class="input-group input-group-sm input-group-minimal">
										...
										<input type="text" name="exchangerate" class="form-control" data-mask="fdecimal" placeholder="Formatted Decimal" data-dec="," data-rad="." maxlength="10" />
									</div>
