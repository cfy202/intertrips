                 ...
                 html += "<div class=\"col-md-3 col-sm-4 col-xs-6\">"+
										"<div class=\"album-image\">"+
										    ...
										    "<div class=\"image-checkbox\">"+
											   "<input type=\"radio\" class=\"imgcheckbox\" name=\"checkbox\" value=\""+e.url+"\" imgid=\""+e.id+"\" onclick=\"selectid(this)\"/>"+
										    "</div>"+
									    "</div>"+
								    "</div>";
			});
		 ...
		 //根据运营中心异步查询orderid和上级
		  $('#costnumber').bind('change', function () {
		       $.ajax({
	             ...
	             data: {
	                   type:$("#type").val(),costnumber:$("#costnumber").val()
	                   },
	             dataType: "json",
	             success: function(data){
						...
						<div class="panel-body">
							...
							<form role="form" class="form-horizontal" id="regionForm" action="${ctx!}/admin/region/save.do" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="namepy" class="form-control" id="namepy">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select class="form-control" name="type" id="type">
											...
											<option value="5">机票</option>
											<option value="6">目的地</option>
											<option value="7">美食</option>
											<option value="8">导游</option>
											<option value="9">租车</option>
											<option value="10">门票</option>
										</select>
									</div>
								</div>
										...
										<select class="form-control" name="upid" id="upid">
										    ...
										    <optgroup label="英文名称 - 中文名称">
												...
												<#list regionlist as regionlist>
	            									<option value="${(regionlist.id)!}" >${(regionlist.levelstr)!}${(regionlist.namepy)!} - ${(regionlist.name)!}</option>
	            								</#list>
            								</optgroup>
										</select>
									</div>
