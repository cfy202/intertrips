...
<head>
	...
	$(document).ready(function() {
		...
		$("#uploadify1").uploadify({
			...
			'script': "${ctx!}/upload.do?path=images/hotel",
	 ...
	 function updateRegion(costnumber,region){
		   ...
		   $.ajax({
			...
			data: "costnumber="+costnumber+"&type=4",
			cache:false,
			success: function(data) {
			   $.each(data, function(i, des) {
			    ...
			    $("#regionid").val("${(hotel.regionid)}").trigger("change");
			    }else{
	...
	function saveUserPictproal(response) {
		...
		$.ajax({
			type: "POST",
			url: "${ctx!}/admin/hotel/savepic.do",
...
<body class="page-body">
	...
	<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
		...
		<div class="main-content">
			...
			<form role="forl" action="${ctx!}/admin/hotel/save.do" id="rootwizard" method="post" class="form-wizard validate">
				...
				<div class="tab-content no-margin">
					...
					<div class="row">
						...
						<div class="row">
							...
							<div class="col-md-5">
								<div class="form-group">
									<label class="control-label" for="city">产品积分</label>
									<input class="form-control" name="score" value="${(product.score)!}" data-validate="required" digits="true" placeholder="请填写产品积分" />
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-md-5">
								<div class="form-group">
									...
									<input class="form-control" name="minprice" value="${(product.minprice)?c}" id="minprice" data-validate="number" placeholder="输入最低价格" />
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<br />
									<input type="checkbox" name ="ishot" value="${(product.ishot)!}" class="iswitch iswitch-purple"<#if product.ishot??&&product.ishot=1 >checked</#if> >
								...
								<div class="form-group">
								    ...
								    <input type="checkbox" name ="isshow" value="${(product.isshow)!}"  class="iswitch iswitch-purple" <#if product.ishot??&&product.isshow=1 >checked</#if>>
								</div>
								...
								<div class="form-group">
								    ...
								    <input type="checkbox" name ="indexShow" value="${(product.indexShow)!}"  class="iswitch iswitch-purple" <#if product.ishot??&&product.indexShow=1 >checked</#if> >
								</div>
							</div>
					...
					<div class="tab-pane with-bg" id="fwv-2">
							<div class="row">
									...
									<div class="form-group">
											<label class="col-sm-2 control-label">酒店分类</label>
											
											<div class="col-sm-10">
												<select class="form-control" id = "regionid" value="${(hotel.regionid)!}" name = "regionid">
					...
					<div class="row">
								<div class="form-group">
									<label class="col-sm-2 control-label" for="hotelname">英文名称</label>								
									<div class="col-sm-10">
										<input type="text" name="hotelname" value="${(hotel.hotelname)!}" class="form-control" id="hotelname" placeholder="">
									</div>
								</div>
						...
						<div class="row">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="hotelcn" value="${(hotel.hotelcn)!}" class="form-control" id="field-2" placeholder="">
									</div>
								</div>
							</div>
						 <br />
						...
						<div class="row">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="hotelweb" value="${(hotel.hotelweb)!}" class="form-control" placeholder="">
									</div>
								</div>
							</div>
						 <br />
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select class="form-control" name="hotelstar" id="hotelstar">
											<#list ["5","4.5","4","3.5","3","2"] as star>
          										<option value="${star}" <#if hotel.hotelstar?? && "${(hotel.hotelstar)!}"=="${star}">selected="selected"</#if>>${star}</option> 
          									</#list> 
										</select>
									</div>
								</div>
						...
						<div class="row">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select class="form-control" name="destinationid" id="UPID" >
											<#list destination as destination>
            									<option value="${(destination.id)!}" <#if hotel.destinationid ?? && hotel.destinationid=destination.id>selected="selected"</#if>>${(destination.name)!}-${(destination.namecn)!}</option>
            								</#list>
										</select>
									</div>
								</div>
						...
						<div class="row">
							    ...
							    <div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="hoteltelephone" value="${(hotel.hoteltelephone)!}" class="form-control" placeholder="">
									</div>
								</div>
						</div>
						...
						<div class="row">
							<div class="form-group">
									<label class="col-sm-2 control-label" for="field-5">地址</label>
									<div class="col-sm-10">
										<textarea class="form-control" name="hoteladdress"  cols="5" id="field-5">${(hotel.hoteladdress)!}</textarea>
									</div>
								</div>
						</div>
						...
						<div class="row">
							<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" name="hoteldescription"  cols="5" id="field-5">${(hotel.hoteldescription)!}</textarea>
									</div>
								</div>
						</div>
						...
						<div class="row">
							<div class="form-group">
									<label class="col-sm-2 control-label" for="field-5">位置</label>
									<div class="col-sm-10">
										<textarea class="form-control" name="hotellocation"  cols="5" id="field-5">${(hotel.hotellocation)!}</textarea>
									</div>
								</div>
						</div>
						...
						<div class="row">
							<div class="form-group">
									<label class="col-sm-2 control-label" for="field-5">娱乐项目</label>
									<div class="col-sm-10">
										<textarea class="form-control" name="hotelamenities"  cols="5" id="field-5">${(hotel.hotelamenities)!}</textarea>
									</div>
								</div>
						</div>
						...
						<div class="row">
							<div class="form-group">
									<label class="col-sm-2 control-label" for="field-5">设施</label>
									<div class="col-sm-10">
										<textarea class="form-control" name="hotelfacilities"  cols="5" id="field-5">${(hotel.hotelfacilities)!}</textarea>
									</div>
								</div>
						</div>
						...
						<div class="row">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="sort"  value="${(hotel.sort)!}" class="form-control" id="field-2" placeholder="">
									</div>
								</div> 
					...
					<div class="tab-pane with-bg" id="fwv-3">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
								    <input name="id" type="hidden" id="id" value="${(hotel.id)!}">
								    <input name="productid" type="hidden" id="id" value="${(hotel.productid)!}">
