				...
				<div class="tab-content no-margin">
					...
					<div class="row">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="hotelname" class="form-control" id="hotelname" placeholder="">
									</div>
								</div>
						...
						<div class="row">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="hotelcn" class="form-control" id="field-2" placeholder="">
									</div>
								</div>
							</div>
						 <br />
						...
						<div class="row">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="hotelweb" class="form-control" placeholder="">
									</div>
								</div>
							</div>
						 <br />
						...
						<div class="row">
							    ...
							    <div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="hoteltelephone" class="form-control" placeholder="">
									</div>
								</div>
						</div>
						...
						<div class="row">
							<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" name="hoteladdress"  cols="5" id="field-5"></textarea>
									</div>
								</div>
						</div>
						...
						<div class="row">
							<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" name="hoteldescription"  cols="5" id="field-5"></textarea>
									</div>
								</div>
						</div>
						...
						<div class="row">
							<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" name="hotellocation"  cols="5" id="field-5"></textarea>
									</div>
								</div>
						</div>
						...
						<div class="row">
							<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" name="hotelamenities"  cols="5" id="field-5"></textarea>
									</div>
								</div>
						</div>
						...
						<div class="row">
							<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" name="hotelfacilities"  cols="5" id="field-5"></textarea>
									</div>
								</div>
						</div>
