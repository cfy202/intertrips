  ...
  <div class="container">
    <div class="cards overlap" style="margin-top:0;">
    	<div class="pay_finish_tit">
        	<h2 style="display: inline-block;height: 30px;line-height: 30px;background: url(background/pay_icon_1.png) left top no-repeat;padding-left: 35px; font-size:24px;">You have paid successfully!</h2>
        </div>
        <div class="Payment_Method shadow">
            <div class="pay_finish_info">
                <h2 style="font-size:24px;">Order No.：${orderNo!}</h2>
                <p style="font-size:14px; margin-bottom:0; line-height:24px;">We have received your order and sent the order information you booked to your email ${email!}</p>
                <p style="font-size:14px; margin-bottom:0; line-height:24px;">We will send the finally comfirmed "Electronic Travel Voucher"to your email within 2 workdays after we received payment.</p>
            </div>
