  ...
  <div class="container">
    <div class="cards overlap" style="margin-top:0;">
    	<div class="pay_finish_tit">
        	<h2 style="display: inline-block;height: 30px;line-height: 30px;background: url(background/pay_icon_1.png) left top no-repeat;padding-left: 35px; font-size:24px;">You have booked successfully!</h2>
        </div>
