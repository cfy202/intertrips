	...
	<div class="container">
        <div class="row">
            ...
            <div id="downNavigation" class="col-md-2 col-md-offset-1 hidden-xs">
    			<#list navigation2 as navigation2>
    				<#if navigation2.upid="root">
    					<#if navigation2_index !=0>
		         </ul>
            </div>
            <div class="col-md-2 hidden-xs">
    					</#if>
                <h2 class="h5" style="margin:0; color:#fff; margin-bottom:10px;">${(navigation2.name)!}</h2>
            	<ul class="list-layout">
                	</#if>
                	<#if navigation2.upid !="root">
                    <li><a href="${ctx!}${(navigation2.url)!}" class="link-contrast">${(navigation2.name)!}</a></li>
                	</#if>
            	</#list>
                </ul>
            </div>
            <#if frontCode??&&frontCode='AUD'>
            <div class="col-md-2 hidden-xs">
                <h2 class="h5" style="margin:0; color:#fff; margin-bottom:10px;">Tel</h2>
                <ul class="list-layout">
                    <li><i class="fa fa-phone" style="margin-right:10px; color:#fff;"></i> <a href="" class="link-contrast">1800 18 8687</a></li>
                </ul>
            </div>
            </#if>
            <#--
        ...
        <div id="mobileDownNavigation" class="space-4 space-top-4 hide visible-xs">
            <ul class="list-inline">
            	<#list navigationPhoneList as navigationPhone>
                <li><a href="${ctx!}${(navigationPhone.url)!}" class="link-contrast">${(navigationPhone.name)!}</a></li>
            	</#list>
            </ul>
        </div>
        <#--手机版下导航-->
...
<#--
<script text="javascript" src='${ctx!}/assets-web/js/frontInclude.js'></script>
...
$(function(){
    ...
    $(".currency-selector").val("${(frontCode)}").trigger("change");
