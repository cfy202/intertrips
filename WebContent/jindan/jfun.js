	  ...
	  if(name==''){
		...
		$("#name").focus();
		  ...
		  $("#email").focus();
			 ...
			 $.ajax({
					type : "GET",
					url : "front/action/sendMial.do",
					data : "name=" + name + "&email=" + email + "&duijiangId=" + duijiangId+ "&title=" + title,
					success : function(msg) {
						var temp = msg.replace(/(^\s*)|(\s*$)/g, "");
						$(".description").html(temp);
						$(".description").addClass("gotoward");
