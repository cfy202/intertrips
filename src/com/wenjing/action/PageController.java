...
//		List<String> costnumber = Tools.getCostNumber(request);
		List<Page> page = pageService.findAll(Tools.getCostNumber(request),0);		
		model.addAttribute("page", page);
		return "/admin/manage/page/page.ftl";
	}
	...
	public String delete(@RequestParam("id") String id) {
		...
		return "redirect:/admin/page/list.do";
	}
	...
	public String update(Page page, Model model) {
		...
		return "/admin/manage/page/pageUpdate.ftl";
	}
	...
	public String add(Page page, Model model){
		...
		model.addAttribute("costlist", costlist);
		return "/admin/manage/page/pageAdd.ftl";
	}
	...
	public String createhome(@RequestParam("costnumber")String costnumber,@RequestParam("id")String id,Model model) throws Exception{
		...
		if(costnumber!=null&&costnumber.equals("d8fe5ef1de7747ab86588f9880f1aa77")){
		page.setFilepath("index.html");
		pageService.create(costnumber, page, request);
		}else{
			page.setFilepath("auindex.htm");
			pageService.create(costnumber, page, request);	
		}
		return "redirect:/admin/page/list.do";
	}
