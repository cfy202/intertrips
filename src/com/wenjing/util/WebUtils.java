...
public final class WebUtils {
    ...
    public static void addCookie(HttpServletRequest request, HttpServletResponse response, String name, String value, Integer maxAge) {
    	 addCookie(request, response, name, value, maxAge, Member.COOKIE_PATH, Member.COOKIE_DOMAIN, null);
    }
    ...
    public static void addCookie(HttpServletRequest request, HttpServletResponse response, String name, String value) {
        addCookie(request, response, name, value, 60 * 30, Member.COOKIE_PATH, Member.COOKIE_DOMAIN, null);
    }
...
//        removeCookie(request, response, name, setting.getCookiePath(), setting.getCookieDomain());
    	  removeCookie(request, response, name,  Member.COOKIE_PATH, Member.COOKIE_DOMAIN);
    }
